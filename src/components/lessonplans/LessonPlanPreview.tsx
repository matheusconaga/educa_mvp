    ...
    return (
      <div className="rounded-3xl border border-border bg-card p-12 shadow-md h-full flex justify-center">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-foreground mb-2">No Lesson Plan Yet</h3>
          <p className="text-sm text-muted-foreground">
            Fill in the form on the left and click "Generate Lesson Plan" to create your AI-powered lesson plan.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-foreground">Lesson Plan Preview</h2>
      ...
      <div className="rounded-3xl border border-border bg-card p-8 shadow-md space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4 text-sm">
          ...
          <div>
            ...
            <span className="ml-2 font-medium text-foreground">{content?.duration} minutes</span>
          </div>
        </div>

        {/* Learning Objectives */}
        <div>
          <h3 className="text-lg font-semibold text-foreground mb-2">Learning Objectives</h3>
          {isEditing ? (
            <textarea
        ...
        {/* Required Materials */}
        <div>
          <h3 className="text-lg font-semibold text-foreground mb-2">Required Materials</h3>
          <div className="flex flex-wrap gap-2">
        ...
        <div>
          <h3 className="text-lg font-semibold text-foreground mb-2">Teaching Methodology</h3>
          <div className="flex flex-wrap gap-2">
        ...
        {/* Lesson Development */}
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-foreground">Lesson Development</h3>

          <div>
            <h4 className="text-md font-medium text-foreground mb-2">Introduction</h4>
            {isEditing ? (
              <textarea
          ...
          <div>
            <h4 className="text-md font-medium text-foreground mb-2">Main Activities</h4>
          ...
          <div>
            <h4 className="text-md font-medium text-foreground mb-2">Practice</h4>
            {isEditing ? (
              <textarea
          ...
          <div>
            <h4 className="text-md font-medium text-foreground mb-2">Assessment</h4>
            {isEditing ? (
              <textarea
          ...
          <div>
            <h4 className="text-md font-medium text-foreground mb-2">Homework</h4>
            {isEditing ? (
              <textarea
        ...
        {content?.adaptations && (
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-2">Adaptations</h3>
